...
<template>
    <Head title="Yeni hasar" />

    <AuthenticatedLayout>
        <template #header>
            <div>
                <h1 class="text-lg font-semibold text-slate-900 dark:text-white">Yeni hasar kaydı</h1>
            </div>
        </template>
        ...
        <div class="mx-auto max-w-2xl">
            ...
            >
                ...
                <div>
                    <InputLabel value="Dosya numarası" />
                    <input
                ...
                <div>
                    <InputLabel value="Müşteri bilgilendirme notu" />
                    <textarea
